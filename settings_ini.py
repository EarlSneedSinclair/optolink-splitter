...
# MQTT +++++++++++++++++++
mqtt = "192.168.1.106:1883"     # e.g. "192.168.0.123:1883"; set None to disable MQTT
...
viessdata_csv_path = "/home/pi/Public/"
buffer_to_write = 60
dec_separator = ","
...
w1sensors = {
    ...
    0xFFF8 : ('28-0e95d4464f78', 'ds18b20'),
    #0xFFFd : ('28-3ce1d443a4ed', 'ds18b20'),
}

# polling datapoints +++++++++++++++++++
poll_interval = 20      # seconds. 0 for continuous, set -1 to disable Polling
poll_items = [
...
#    ("Frostgefahr, aktuelle RTS etc", 0x2500, 22, 'raw'),
    ...
    ("HO2B_Aktuelle_Leistung", 0x74A3, 4, 1, False),
    ("Gasverbrauch_Heizen", 0x9000, 4, 1, False),
    ("Gasverbrauch_WW", 0x9134, 4, 1, False),

    # 1-wire
    ("WW/SpeicherTemp_oben", 0xFFF4),
    ("RL/RuecklaufTemp_Sensor", 0xFFF8),
    #("WW/El_Heater", 0xFFFd),
